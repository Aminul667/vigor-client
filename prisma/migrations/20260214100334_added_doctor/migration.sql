/*
  ...
  - You are about to drop the column `deleatedAt` on the `specialities` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "specialities" DROP COLUMN "deleatedAt",
